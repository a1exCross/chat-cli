...
type ChatV1Client interface {
	...
	ListChats(ctx context.Context, in *ListRequest, opts ...grpc.CallOption) (*ListResponse, error)
}
...
func (c *chatV1Client) ListChats(ctx context.Context, in *ListRequest, opts ...grpc.CallOption) (*ListResponse, error) {
...
type ChatV1Server interface {
	...
	ListChats(context.Context, *ListRequest) (*ListResponse, error)
...
func (UnimplementedChatV1Server) ListChats(context.Context, *ListRequest) (*ListResponse, error) {
...
func _ChatV1_ListChats_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(ChatV1Server).ListChats(ctx, req.(*ListRequest))
	}
	return interceptor(ctx, in, info, handler)
}
